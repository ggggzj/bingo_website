...
- [ ] 1.1 Write `lib/db/src/import-coach-data.ts` (args: `--email`,
...
- [ ] 2.1 Add `scripts/coach_api.py` (env-driven, stdlib urllib,
...
- [ ] 2.2 Add the remote branch in `daily.py` (fetch plan, adapt to the
...
- [ ] 3.1 Full rehearsal against the scratch stack: import a crafted local
