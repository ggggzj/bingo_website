...
- [x] 1.1 Create `src/pages/Coach.tsx` with the auth/gate skeleton
...
- [x] 1.2 Add consistency panel (streak, adherence, 91-day CSS-grid
...
- [x] 1.3 Add settings panel (daily minutes, new/day, sprint window,
...
- [x] 2.1 Add the `/coach` route in `App.tsx` and the conditional "Coach"
...
- [x] 3.1 Run `pnpm run typecheck` and `pnpm run build`; then a live
